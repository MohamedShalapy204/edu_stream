...
Guides the writing of clean, maintainable, and idiomatic JavaScript/TypeScript and React code. Enforces design patterns, strict typing, and high-quality testing practices (including AAA pattern and boundary testing).

```bash
npx skills add google-labs-code/stitch-skills --skill clean-react-code --global
```

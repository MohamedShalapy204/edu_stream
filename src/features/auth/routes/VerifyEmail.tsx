                ...
                <AnimatePresence mode="wait">
                    {status === 'verifying' && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <h1 className="text-3xl font-heading font-black tracking-tight">{t('auth.verify.verifyingTitle')}</h1>
                                <p className="text-base-content/60 font-medium">{t('auth.verify.verifyingSubtitle')}</p>
                            </div>
                        </motion.div>
                    )}
                    ...
                    {status === 'success' && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <h1 className="text-4xl font-heading font-black tracking-tight text-base-content">{t('auth.verify.successTitle')}</h1>
                                <p className="text-base-content/60 font-medium max-w-sm mx-auto">{t('auth.verify.successSubtitle')}</p>
                            </div>
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                    ...
                    {status === 'error' && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <h1 className="text-3xl font-heading font-black tracking-tight">{t('auth.verify.errorTitle')}</h1>
                                <p className="text-base-content/60 font-medium max-w-xs mx-auto">
                                    {error?.message || t('auth.verify.errorSubtitle')}
                                </p>
                            </div>
